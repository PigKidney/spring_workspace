...
const quiz2_1 = document.getElementById('quiz2-1'); 

const quiz2_2 = document.getElementById('quiz2-2'); 
const modifyFruitId = document.getElementById('modify-fruit-id'); 


const quiz2_3 = document.getElementById('quiz2-3'); 
